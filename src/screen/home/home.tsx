...
export const HomeScreen: React.FC = () => {
  ...
  const { statis, jobs, companies, reportJobs, cvs } = data;
    ...
    <ScrollView>
      <View style={styles.container}>
        <View>
          ...
          <View style={styles.vJobs}>
            ...
            <View>
              <FlatList
                ...
                renderItem={({ item }) => {
                  const { name, company, salary, timeToApply, address } = item;
                  return (
                    <View style={styles.jobItem}>
                      ...
                      <View style={styles.vJobItemBottom}>
                        <View style={styles.vJobInfoRow}>
                          ...
                          />
                          <Text style={styles.tJobInfoLabelRow}>Address:</Text>
                    ...
                    <View style={styles.container}>
                      <FlatList
                        ...
                        renderItem={({ item }) => {
                          ...
                          const { fullname, gender, birthday, address } =
                            detail;
                          return (
          ...
          <View>
            <View style={styles.vLabel}>
              <Text style={styles.tLabel}>Complaints</Text>
              <Text style={styles.tSeeAll}>See all</Text>
            </View>
            <View>
              <FlatList
